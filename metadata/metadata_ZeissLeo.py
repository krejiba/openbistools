...
def get_metadata(filename, keys):
    ...
    field_map = {
        ...
        "Time": "TIME",
        "Tilt Angle": "TILT_CORRECTION_DEG",
        "Tilt Corrn.": "TILT_CORRECTION_ON",
    ...
    if tilt_correction_on:
        ...
        metadata_dict["TILT_CORRECTION_ON"] = tilt_correction_on
        if not tilt_correction_on:
            metadata_dict["TILT_CORRECTION_DEG"] = 0
